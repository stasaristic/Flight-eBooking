...
namespace Flight_eBooking.Migrations
{
    ...
    {
        private string AgentRoleId = Guid.NewGuid().ToString();
        ...
        private void SeedRolesSQL(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@$"INSERT INTO [dbo].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
            VALUES ('{AgentRoleId}', 'Agent', 'AGENT', null);");
            migrationBuilder.Sql(@$"INSERT INTO [dbo].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
        ...
        private void SeedUser(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                @$"INSERT [dbo].[AspNetUsers] ([Id], [FirstName], [LastName],[Funds], [UserName], [NormalizedUserName], 
                [Email], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], 
                [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) 
                VALUES 
                (N'{User1Id}', N'Test 2', N'Lastname', 250.00, N'test2@test.ca', N'TEST2@TEST.CA', 
            ...
            migrationBuilder.Sql(
                ...
                [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) 
                VALUES 
                (N'{User2Id}', N'Test 3', N'Lastname', 350.00, N'test3@test.ca', N'TEST3@TEST.CA', 
